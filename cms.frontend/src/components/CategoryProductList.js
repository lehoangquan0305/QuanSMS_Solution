    ...
    if (loading) {
        return (
            <div className="text-center my-4 py-4">
                ...
                <div className="mt-2 text-muted" style={{ fontSize: '0.9rem' }}>Đang tải danh mục sản phẩm...</div>
            </div>
        );
    }
                    ...
                    {categoryProducts.length === 0 ? (
                        ...
                        categoryProducts.map((item) => (
                            <button
                                ...
                                style={{ fontSize: '0.95rem', color: '#495057', borderLeft: '3px solid transparent' }}
                                // Thêm hiệu ứng hover nhỏ bằng CSS inline nếu thích, hoặc giữ nguyên chuẩn Bootstrap
                            >
