...
function LatestProducts() {
    ...
    useEffect(() => {
        const fetchLatest = async () => {
            ...
            try {
                // Gọi API sản phẩm mới nhất đã sửa ở Backend số nhiều (api/products/latest)
                const res = await fetch(`${API_URL}/products/latest`);
                if (res.ok) {
    ...
    return (
        <section className="section-block-cyber bg-cyber-dark-accent">
            <div className="container" style={{ position: "relative" }}>
                <h2 className="section-title-cyber text-glow-cyber-home fw-mono-home mb-2 text-center" style={{ color: '#22d3ee' }}>
                    🔥 SẢN PHẨM MỚI NHẤT
                </h2>
                <div className="cyber-divider-home mx-auto mb-5"></div>
